...
public class RedValleyAppOpenAdService : RedValleyAdService<IAppOpenAd, IAppOpenAdService>, IRedValleyAppOpenAdService
{
    public RedValleyAppOpenAdService(IAppOpenAdService adService, string adUnitId) : base(adService, adUnitId)
    {
    }
